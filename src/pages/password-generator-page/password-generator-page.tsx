...
export const PasswordGeneratorPage = () => {
  ...
  return (
    <>
      <div className="bg-white/10 backdrop-blur-sm flex flex-col pt-4 pb-6 px-4 rounded-md shadow-xl h-full mb-4">
        {/* Tittle */}
      ...
      <div className="flex gap-6">
        <div className="bg-white/50 backdrop-blur-sm flex flex-col pt-4 pb-6 px-4 rounded-md shadow-lg flex-1">
          <h4 className="font-medium mb-2 text-gray-800">Fortify Your Security: Your Password Guardian</h4>
          <p className="text-gray-500">
            Enhance your digital fortress with our Password Validator! Protect your backoffice with confidence as you fortify your defenses against unauthorized access. Your safety is our priority, and we've got you covered with the ultimate password protection solution. Elevate your security game today!
          </p>
        </div>
        <div className="bg-white/50 backdrop-blur-sm flex flex-col pt-4 pb-6 px-4 rounded-md shadow-lg flex-1">
        </div>
